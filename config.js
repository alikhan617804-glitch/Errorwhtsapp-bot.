...
module.exports = {
    ...
    BOT_NAME:              process.env.BOT_NAME || "ERROR 💀",
    OWNER_NUMBER:          process.env.OWNER_NUMBER || "923240993066",
    OWNER_NAME:            process.env.OWNER_NAME || "ERROR",
    DESCRIPTION:           process.env.DESCRIPTION || "ERROR WhatsApp Bot",
    ALIVE_IMG:             process.env.ALIVE_IMG || "https://files.catbox.moe/5uli5p.jpeg",
    LIVE_MSG:              process.env.LIVE_MSG || "ERROR is active",
    ...
    AUTO_STATUS_MSG:       process.env.AUTO_STATUS_MSG || "Seen by ERROR",
    ...
    STATUS_MSG:            process.env.STATUS_MSG    || 'ERROR 💖 SUCCESSFULLY VIEWED YOUR STATUS',
    ...
    THEME:                 (process.env.THEME || 'ERROR').toLowerCase().trim(),
    GREETING:              process.env.GREETING || '',
    CHANNEL_URL:          process.env.CHANNEL_URL || 'https://whatsapp.com/channel/0029VbDmAYDCcW4vL9pQTH0o',
